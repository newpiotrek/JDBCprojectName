...
public class Database {
    ...
    public void connect() throws SQLException {
      ...
      /*  while (resultSelectQuery.next()) {
        ...
        // spr�buj zrobi? jeszcze sortowanie po kluczach u?ywaj?c TreeMap (mo?e Ci by? potrzebne skorzystanie z Comparable :) ). Druga kwestia, kt�r? mo?esz jeszcze zrobi? to zamieni? String na Word jako klucz (w osobnej klasie).
